...
public class Variables03 {
    ...
    public static void main(String[] args) {
        ...
        int intVar1 = 1; // корректное значение для переменной типа int
        int intVar2 = 2;
        int intVar3 = 3; // добавлен тип переменной int
    
        double doubleVar1, doubleVar2, doubleVar3, doubleVar4;
        doubleVar1 = 1.1;
        doubleVar2 = 2.1; // отредактировано имя переменной
        doubleVar3 = 3.1;// исправлена повторная инициализация переменной
        doubleVar4=4.1; // проинициализирована переменная
    
        String stringVar1 = "1"; // корректное значение строковой переменной - добавлены кавычки
        String stringVar2 = "2";
