...
public class PathDemo {
    public static void main(String[] args) {
        ...
        paths[0] = Paths.get("D:\\Prog_java_projects\\Java_DB_labs\\3rdCourse\\Java_sem_6\\files\\employees.txt");
        paths[1] = Paths.get("D:/Prog_java_projects/Java_DB_labs/3rdCourse/Java_sem_6/files/employees.txt");
        paths[2] = Paths.get("D:", "Prog_java_projects", "Java_DB_labs", "3rdCourse", "Java_sem_6", "files", "employees.txt");
        ...
        Path rp = Paths.get("D:/Prog_java_projects/Java_DB_labs/3rdCourse/Java_sem_5/../Java_sem_6/files/employees.txt");
        System.out.println("rp.normalize() [" + rp.normalize() + "]");

        Path sp = Paths.get("D:/Prog_java_projects/Java_DB_labs/3rdCourse/Java_sem_6/files/IO/..//NIO/demoFiles.txt");
