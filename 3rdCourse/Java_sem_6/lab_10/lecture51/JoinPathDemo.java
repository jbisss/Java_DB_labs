...
public class JoinPathDemo {
    public static void main(String[] args) {
        Path basicPath = Paths.get("D:/PolyProjects");
        ...
        Path p1 = Paths.get("D:/PolyProjects/3rdCourse/Java_sem_6/files/IO/Logs/errorLogs.txt");
        Path p2 = Paths.get("D:/PolyProjects/3rdCourse/Java_sem_6/files/IO");
